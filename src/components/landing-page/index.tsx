    ...
    <View style={[styles.container, { minHeight: windowHeight }]}>
      ...
      {/* <View style={styles.overlay}>
        <FadeInImage
          ...
          source="https://nextuipro.nyc3.cdn.digitaloceanspaces.com/components-images/backgrounds/bg-gradient.png"
        />
      </View> */}
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  heading: {
    fontFamily: "Inter",
    color: "black",
    fontSize: 48, // Responsive font sizing
    lineHeight: 1.2,
    letterSpacing: -1,
    fontWeight: "400",
  },
  subHeadingText: {
    ...
    fontSize: 22, // Approximate Tailwind `text-base`
